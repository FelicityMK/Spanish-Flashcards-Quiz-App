...
words = [
    ...
    {"spanish": "con", "english": "with"},  # fixed 'can' to 'con'
    ...
    {"spanish": "le", "english": "his/her/you (indirect object)"},
...
def quiz_user(words):
    ...
    for word in words:
        print(f"\nWhat is the English translation of '{word['spanish']}'?")
    ...
    print(f"\nQuiz complete! Your score: {score}/{len(words)}")

def main():
    print("Welcome to the Spanish Flashcards Quiz App!")
